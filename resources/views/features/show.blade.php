                ...
                <div class="panel panel-default">
                    <div class="panel-heading" ng-init="search=''">
                        <h3>
                            ...
                            <a href="{{ route('admin.productsdetails.create') }}" class="btn btn-default btn-md pull-right visible-lg-inline">{{ trans('features.new_feature') }}</a>
                            <a href="{{ route('admin.productsdetails.create') }}" class="btn btn-default btn-md visible-xs-block">{{ trans('features.new_feature') }}</a>
                        </h3>
                    </div>
                    <ul class="list-group">
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-md-3"><a href="{{ route('admin.productsdetails.edit',$feature['id']) }}" class="btn btn-default btn-md pull-right">{{ trans('globals.edit') }}</a></div>
                            </div>
                        </li>
                        <li class="list-group-item">
                            <div class="row">
