        ...
        <div class="row" ng-controller="LoginController">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <label>
                        &nbsp;<input name="newuser" type="radio" value="0" ng-click="setHavePassword(true)"
                                     checked="havePassword">&nbsp;{{ trans('user.password_message.have') }}
                        <br>
                        &nbsp;<input name="newuser" type="radio" value="1"
                                     ng-click="setHavePassword(false)">&nbsp;{{ trans('user.password_message.nohave') }}
                    </label>
                </div>
                ...
                <div class="form-group">
                    <label>
                        <input ng-disabled="!havePassword" type="checkbox"
                               name="remember"> {{ trans('user.remember_me') }}
                        &nbsp;|&nbsp;
